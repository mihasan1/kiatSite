  ...
  <tr>
    ...
    <td class="background_11">
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="218">
        <tr>
          <td class="toolbar_general_5"><div class="toolbar_text_1">ПОМИЛКА 403</div></td>
        </tr>
        <tr>
          <td class="toolbar_general_6"><p align="center" class="стиль4">&nbsp;</p>
            <p align="center" class="стиль6">ПОМИЛКА 403</p>
            <p align="center" class="стиль6">Вхід заборонено  !</p>
