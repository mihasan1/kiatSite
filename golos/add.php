...
if(!$cook){
$error=$error."<br>Помилка запису інформації в cookies";
}
}else{
$error="Ваш голос не прийнятий!";
}
}else{
$error="Помилка при відправленні даних";
}
}else{
$error="Ви не можете проголосувати в цьому опитуванні";
}
}
?>
<html>
...
<meta http-equiv="Тип-содержимое" content="text/html; charset=windows-1251"><meta http-equiv="Тип-содержимое" content="text/html; charset=windows-1251"></head>
<body>
<?
if(isset($error)){
?>
...
<table align=center width="<?print$w;?>" cellpadding=0 cellspacing=0   style="margin-top:5;margin-bottom:5;"><tr><td>
<table width="<?print$w;?>" align=center cellpadding=2 cellspacing=1 border=0><tr bgcolor="#EAEBFF" style="{font-size:8pt;color:#000044;font-family:verdana;}"><td>
<h5 align="center" style="margin-bottom:5;">Результати опитування</h5>
...
<?
print "<br><div align=left><b>Усього голосів:</b> ".$all."</div>";
...
print "Опититування не знайдено!";
}
?>
</div>
</td></tr></table>
...
<html>
<head>
<title>Опитування: <?print$_GET['p_q'];?></title>
<style>
body{background-color:#FFFFFF;font-family:verdana;font-size:8pt;}
a:link{text-decoration:none;color:#000066;}
a:hover{text-decoration:none;color:#0000EE;}
...
<table align=center width="<?print$w;?>" cellpadding=0 cellspacing=0   style="margin-top:5;margin-bottom:5;"><tr><td>
<table width="<?print$w;?>" align=center cellpadding=2 cellspacing=1 border=0><tr bgcolor="#EAEBFF" style="{font-size:8pt;color:#000044;font-family:verdana;}"><td>
<h3 align="center" style="margin-top:10;margin-bottom:10;">Опититування не знайдено</h3>
</td></tr></table>
</td></tr></table>
<?
}
...
<a href="#" onClick="parent.self.close(); return false" title="Закрити вікно">Закрити вікно</a>
</td></tr></table>
</td></tr></table>
</body>
</html>
