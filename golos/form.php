...
if($ex){
?>
<table align=<?print$p_align;?> width="<?print$p_width;?>" cellpadding=0 cellspacing=0 border=0 <tr><td>
<table width="<?print$p_width;?>" align=center cellpadding=2 cellspacing=<?print$p_bwidth;?> border=0><tr  style="{font-size:<?print$p_txtsize;?>;color:<?print$p_txtcolor;?>;font-family:<?print$p_font;?>;}"><td>
...
<div align="center"><a href="<?print$p_path;?>add.php?name=<?print$pollname;?>&w=<?print$p_rwidth;?>&coltype=<?print$p_coltype;?>" target="_blank" title="Подивитися результати опитування">Результати</a>
</form>
</td></tr></table>
</td></tr></table>
<?
...
<table align=<?print$p_align;?> width="<?print$p_width;?>" cellpadding=0 cellspacing=0 border=0 <tr><td>
<table width="<?print$p_width;?>" align=center cellpadding=2 cellspacing=<?print$p_bwidth;?> border=0><tr  style="{font-size:<?print$p_txtsize;?>;color:<?print$p_txtcolor;?>;font-family:<?print$p_font;?>;}"><td>
<div align="center">Опитування <b><?print$pollname;?></b> не знайдено!</b></div>
</td></tr></table>
</td></tr></table>
<?
}
...
<table align=<?print$p_align;?> width="<?print$p_width;?>" cellpadding=0 cellspacing=0 border=0 ><tr><td>
<table width="<?print$p_width;?>" align=center cellpadding=2 cellspacing=<?print$p_bwidth;?> border=0><tr  style="{font-size:<?print$p_txtsize;?>;color:<?print$p_txtcolor;?>;font-family:<?print$p_font;?>;}"><td>
<div align="center">Ви не задали ім'я опитування</b></div>
</td></tr></table>
</td></tr></table>
<?
}
