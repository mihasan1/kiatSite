...
<!--
.стиль4 {font-size: 14}
.стиль6 {font-size: 14; font-weight: bold; }
-->
</style>
      ...
      <td class="plugin_1"><table border="0" cellpadding="0" cellspacing="0" class="width_100">
        ...
        <tr>
          ...
          <td class="plugin_3"><p>Зараз на сайті - 
            <script src="./includes/online.php "></script>  <br />
               Сторінку оновили - <? $type = "text"; include("./includes/count.php"); ?>          
          </td>
                      ...
                      <td class="plugin_1"><table border="0" cellpadding="0" cellspacing="0" class="width_100">
                        ...
                        <tr>
                          ...
                          <td class="plugin_3">                            <div align="right"></div>
                            <div align="right"><? require ('phprusearch/sinc/form.php') ?>
                            </div></td>
                          <td class="plugin_7"></td>
                        </tr>
                        <tr>
...
<table cellspacing=4><tr><td>
                            <input type="button" class="button" name="btnSubmit" value=" Наказ" onClick="javascript: document.location='nakaz.php';" onMouseOver="javascript:this.style.backgroundColor='#D2D2FF';" onMouseOut="javascript:this.style.backgroundColor='#ffffff';" />
       </td></tr>
 ...
 <!--  <object><embed src="ogolos(viboru.d).pdf" width="800" height="600" /></object>   -->
	   
	   
	   
	   <object><embed src="nakaz pro pryznachennya dyrectora.pdf" width="800" height="600" /></object>nakaz pro pryznachennya dyrectora
