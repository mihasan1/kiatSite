...
<input type="button" class="button" name="btnSubmit" value="Про нас" onclick="javascript: document.location='index.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr><tr><td>
...
<input type="button" class="button" name="btnSubmit" value="Інші новини" onclick="javascript: document.location='novosti_drug.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr><tr><td>
<input type="button" class="button" name="btnSubmit" value="Доступ до публічної ініформації" onclick="javascript: document.location='reklama.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr></table>
</form>
</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" class="218">
<tr>
<td class="toolbar_side_1"><div class="toolbar_text_1">Перехід на сайт</div></td>
</tr>
<tr>
<td class="toolbar_side_2"><div align="center"></div>
<div align="center"> <br>
<p><a href="http://www.mon.gov.ua/index.php/ua/"><img src="includes\Mon.jpg" alt="Міністерство освіти і науки" border="0"/></a>
</div>
<div align="center"></div></td>
</tr>
</table></td>
...
<tr>
<td class="toolbar_general_1"><div class="toolbar_text_1">Інші новини</div></td>
</tr>
<tr>
...
background_color = '';
data_font_size = '14px';
data_font_color = '#3300CC';
data_font_name = 'arial';
data_font_weight = 'normal';
data_decoration = 'underline';
anons_font_color = '#000000';
anons_font_size = '14';
anons_font_name = 'times new roman';
anons_font_weight = 'normal';
line = 'yes';
pos = '';
</script>
<script type="text/javascript" src="http://bigbord.net/rss/news_rss/0/10/s/y/w/rss.js.xml" charset="windows-1251">
</script>
<!--bigbord.net Informer end -->
</strong></p>
</div></td>
</tr>
</table></td>
