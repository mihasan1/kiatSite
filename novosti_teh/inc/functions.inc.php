...
function msg($type, $title, $text, $back=FALSE){
  ...
  global $lang;
    ...
    if($back){
        echo"<br /><br> <a href=\"$back\">Вернуться назад</a>";
    }
    echo"</td></tr></table>";
  echofooter();
exit();
...
function echoheader($image, $header_text){
    ...
    $skin_header = preg_replace("/{copyrights}/", "<div style='font-size: 9px; text-transform: uppercase'>Powered by <a style='font-size: 9px' href=\"http://cutenews.ru/\" target=_blank>$config_version_name $config_version_id</a> &copy; 2004 (Original by <a style='font-size: 9px' href=\"http://cutephp.com/\" target=_blank>CutePHP</a>)</div>", $skin_header);
...
function echofooter(){
    ...
    $skin_footer = preg_replace("/{copyrights}/", "<div style='font-size: 9px; text-transform: uppercase'>Powered by <a style='font-size: 9px' href=\"http://cutenews.ru/\" target=_blank>$config_version_name $config_version_id</a> &copy; 2004 (Original by <a style='font-size: 9px' href=\"http://cutephp.com/\" target=_blank>CutePHP</a>)</div>", $skin_footer);
...
////////////////////////////////////////////////////////
// Function:    deCookie
// Author:      Lexa z&к (http://lexa.ekolobok.ru)
// Description: Replaces cyrillic charactars in rememberme-section

function deCookie($result){
        $find = array('%u0430', '%u0431', '%u0432', '%u0433', '%u0434', '%u0435', '%u0451',
'%u0436', '%u0437', '%u0438', '%u0439', '%u043A', '%u043B', '%u043C', '%u043D', '%u043E',
'%u043F', '%u0440', '%u0441', '%u0442', '%u0443', '%u0444', '%u0445', '%u0446', '%u0449',
'%u044A', '%u044B', '%u044C', '%u044D', '%u044E', '%u044F');
        $replace = array('а', 'б', 'в', 'г', 'д', 'е', 'ё', 'ж', 'з', 'и', 'й', 'к', 'л', 'м',
'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'щ', 'ъ', 'ы', 'ь', 'э', 'ю', 'я');
        $result = str_replace($find, $replace , $result);

        $find = array('%u0410', '%u0411', '%u0412', '%u0413', '%u0414', '%u0415', '%u0401',
'%u0416', '%u0417', '%u0418', '%u0419', '%u041A', '%u041B', '%u041C', '%u041D', '%u041E',
'%u041F', '%u0420', '%u0421', '%u0422', '%u0423', '%u0424', '%u0425', '%u0426', '%u0429',
'%u042A', '%u042B', '%u042C', '%u042D', '%u042E', '%u042F');
        $replace = array('А', 'Б', 'В', 'Г', 'Д', 'Е', 'Ё', 'Ж', 'З', 'И', 'Й', 'К', 'Л', 'М',
'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Ф', 'Х', 'Ц', 'Щ', 'Ъ', 'Ы', 'Ь', 'Э', 'Ю', 'Я');
        $result = str_replace($find, $replace , $result);
