...
<input type="button" class="button" name="btnSubmit" value="Програма для вступних іспитів" onclick="javascript: document.location='progrvst.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr><tr><td>
</form>
</tr>
</table>
...
<tr>
<td class="toolbar_general_1"><div class="toolbar_text_1">Програми для вступних іспитів</div></td>
</tr>
<tr>
...
<form>
<table cellspacing=4><tr><td>
<input type="button" class="button" name="btnSubmit" value="З української мови 9 клас" onclick="javascript: document.location='ukr9k.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr><tr><td>
<input type="button" class="button" name="btnSubmit" value="З української мови 11 клас" onclick="javascript: document.location='ukr11k.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr><tr><td>
<input type="button" class="button" name="btnSubmit" value="З математики 9 клас" onclick="javascript: document.location='mat9k.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr><tr><td>
</form>
