...
<input type="button" class="button" name="btnSubmit" value="Положення про ПК" onclick="javascript: document.location='perelik.php';" onmouseover="javascript:this.style.backgroundColor='#D2D2FF';" onmouseout="javascript:this.style.backgroundColor='#ffffff';" />
</td></tr><tr><td>
...
<tr>
<td class="toolbar_general_1"><div class="toolbar_text_1">Положення про приймальну комісію</div></td>
</tr>
<tr>
<td class="toolbar_general_2"><div class="toolbar_text_2">

<p align="left"><span class="стиль7"><strong><a href="includes\polozheny_pro_PP_2015.pdf">Завантажити Положення про приймальну комісію</a></strong></span></p>
